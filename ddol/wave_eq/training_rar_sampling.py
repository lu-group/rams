    ...
    for epoch in pbar:
        ...
        if early_stopping_epoch is not None:
            if iterCounter > early_stopping_epoch:
                # if epoch > rar_update_start_epoch + rar_update_time * rar_update_interval:
    ...
    for i in range(3):
        for sampling_iter in [0, 100, 200, 300, 400]:
            ...
            train(net=net, batch_size=batch_size, max_epoch=max_epoch, TOL=TOL,
                  ...
                  model_path=model_path, model_name=model_name, sample_num=sample_num, PhyLoss=PhyLoss,
