import torch
from loss_random import Loss_Random, sampler_random_uniform_2D
import matplotlib.pyplot as plt

class Loss_RAR(Loss_Random):
    def __init__(self, a, D, device, max_epochs, initial_sampling_info, sample_update_interval,
        ...
        #######################################################################
        super().__init__(a, D, device, max_epochs, initial_sampling_info, sample_update_interval,
                         is_net_transformed=is_net_transformed, is_trainable=is_trainable,
                         training_sample_info=training_sample_info, is_visualized=is_visualized,
                         samBC_update_interval=samBC_update_interval)
